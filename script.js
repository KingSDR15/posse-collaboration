document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      doc.text("POSSE", 20, y); y += lineHeight;
      doc.text("Website: theposse.com", 20, y); y += lineHeight;
      ...
      doc.text(payment, 58, y, { maxWidth: 50 });
      ...
      y += lineHeight;
      doc.setFont("helvetica", "bold");
      doc.text("Invoice Summary", 10, y); y += lineHeight;
      doc.setFont("helvetica", "normal");
  ...
  function afterDownloadSuccess(data) {
    try {
      ...
      if (emailLink) {
        ...
        emailLink.href = `mailto:posseofficialcollaboration@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
      }
    } catch (err) {
